...
-- Simple version without contact preferences to avoid enum type issues
...
BEGIN
    ...
    RAISE NOTICE 'Successfully inserted 150 synthetic contacts with tags and social links';
END $$;